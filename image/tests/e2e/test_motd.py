...
class TestMotdCrud:
    ...
    def test_motd_widget_visible_on_motd_page(self, page: Page, live_server):
        """After creating a MOTD, the MOTD module page shows the entry."""
        page.goto(f"{live_server}/motd/new")
        page.fill('[name="text"]', "E2E Home Widget MOTD")
        page.locator('[type="submit"]').first.click()
        page.wait_for_load_state("networkidle")
        expect(page.locator("body")).to_contain_text("E2E Home Widget MOTD")
